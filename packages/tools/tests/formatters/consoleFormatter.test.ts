...
describe('consoleFormatter', () => {
  it('formatConsoleEvent - formats a console.log message', async () => {
  ...
  it('formatConsoleEvent - formats a console.log message with arguments', async () => {
    const message = getMockConsoleMessage({
      type: 'log',
  ...
  it('formatConsoleEvent - formats a console.error message', async () => {
    const message = getMockConsoleMessage({
      type: 'error',
  ...
  it('formatConsoleEvent - formats a console.error message with arguments', async () => {
    const message = getMockConsoleMessage({
      type: 'error',
      text: 'Something went wrong:',
  ...
  it('formatConsoleEvent - formats a console.error message with a stack trace', async () => {
    const message = getMockConsoleMessage({
      type: 'error',
      text: 'Something went wrong',
      stackTrace: [
  ...
  it('formatConsoleEvent - formats a console.error message with a JSHandle@error', async () => {
    const message = getMockConsoleMessage({
      type: 'error',
      text: 'JSHandle@error',
  ...
  it('formatConsoleEvent - formats a console.warn message', async () => {
    const message = getMockConsoleMessage({
      type: 'warning',
  ...
  it('formatConsoleEvent - formats a console.info message', async () => {
    const message = getMockConsoleMessage({
      type: 'info',
  ...
  it('formatConsoleEvent - formats a page error', async () => {
  ...
  it('formatConsoleEvent - formats a page error without a stack', async () => {
    const error = new Error('Page crashed');
  ...
  it('formatConsoleEvent - formats a console.log message from a removed iframe - no location', async () => {
    const message = getMockConsoleMessage({
      type: 'log',
  ...
  it('formatConsoleEvent - formats a console.log message from a removed iframe with partial location', async () => {
    const message = getMockConsoleMessage({
      type: 'log',
      text: 'Hello from iframe',
      location: {

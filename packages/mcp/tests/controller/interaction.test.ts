...
describe('MCP Controller Interaction Tools', () => {
  describe('browser_get_interactive_elements - Success Cases', () => {
    it(
      'tests that interactive elements are retrieved with simplified format',
      async () => {
        await withMcpServer(async client => {
          ...
          assert.ok(
            textContent.text.includes('Legend'),
    ...
    it(
      'tests that interactive elements are retrieved with full format',
      async () => {
        await withMcpServer(async client => {
          const navResult = await client.callTool({
            name: 'browser_navigate',
    ...
    it(
      'tests that page with no interactive elements is handled',
      async () => {
        await withMcpServer(async client => {
          const navResult = await client.callTool({
            name: 'browser_navigate',
  ...
  describe('browser_get_interactive_elements - Error Handling', () => {
    it(
      'tests that invalid tab ID is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_get_interactive_elements',
    ...
    it(
      'tests that non-numeric tab ID is rejected',
      async () => {
        await withMcpServer(async client => {
          try {
  ...
  describe('browser_click_element - Success Cases', () => {
    it(
      'tests that element click succeeds',
      async () => {
        await withMcpServer(async client => {
  ...
  describe('browser_click_element - Error Handling', () => {
    it(
      'tests that clicking with invalid tab ID is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_click_element',
    ...
    it(
      'tests that clicking with invalid node ID is handled',
      async () => {
        await withMcpServer(async client => {
          const navResult = await client.callTool({
            name: 'browser_navigate',
    ...
    it(
      'tests that non-numeric parameters are rejected',
      async () => {
        await withMcpServer(async client => {
          try {
            await client.callTool({
  ...
  describe('browser_type_text - Success Cases', () => {
    it(
      'tests that typing text into input succeeds',
      async () => {
        await withMcpServer(async client => {
    ...
    it(
      'tests that typing empty string succeeds',
      async () => {
        await withMcpServer(async client => {
          const navResult = await client.callTool({
            name: 'browser_navigate',
    ...
    it(
      'tests that typing special characters succeeds',
      async () => {
        await withMcpServer(async client => {
          const navResult = await client.callTool({
            name: 'browser_navigate',
  ...
  describe('browser_type_text - Error Handling', () => {
    it(
      'tests that typing with invalid tab ID is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_type_text',
    ...
    it(
      'tests that typing with invalid node ID is handled',
      async () => {
        await withMcpServer(async client => {
          const navResult = await client.callTool({
            name: 'browser_navigate',
  ...
  describe('browser_clear_input - Success Cases', () => {
    it(
      'tests that clearing input field succeeds',
      async () => {
        await withMcpServer(async client => {
          // Navigate to a page with an input field
          const navResult = await client.callTool({
  ...
  describe('browser_clear_input - Error Handling', () => {
    it(
      'tests that clearing with invalid tab ID is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_clear_input',
    ...
    it(
      'tests that clearing with invalid node ID is handled',
      async () => {
        await withMcpServer(async client => {
          const navResult = await client.callTool({
            name: 'browser_navigate',
  ...
  describe('browser_scroll_to_element - Success Cases', () => {
    it(
      'tests that scrolling to element succeeds',
      async () => {
        await withMcpServer(async client => {
  ...
  describe('browser_scroll_to_element - Error Handling', () => {
    it(
      'tests that scrolling with invalid tab ID is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_scroll_to_element',
    ...
    it(
      'tests that scrolling with invalid node ID is handled',
      async () => {
        await withMcpServer(async client => {
          const navResult = await client.callTool({
            name: 'browser_navigate',
  ...
  describe('Interaction Tools - Workflow Tests', () => {
    it(
      'tests complete interaction workflow: get elements -> click',
      async () => {
        await withMcpServer(async client => {
          // Navigate to a page
          const navResult = await client.callTool({
    ...
    it(
      'tests complete form workflow: get elements -> type -> clear',
      async () => {
        await withMcpServer(async client => {
          // Navigate to a form
          const navResult = await client.callTool({
    ...
    it(
      'tests complete scroll workflow: get elements -> scroll to element -> click',
      async () => {
        await withMcpServer(async client => {

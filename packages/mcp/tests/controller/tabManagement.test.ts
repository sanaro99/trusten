...
describe('MCP Controller Tab Management Tools', () => {
  describe('browser_get_active_tab - Success Cases', () => {
    it(
      'tests that active tab information is successfully retrieved',
      async () => {
  ...
  describe('browser_list_tabs - Success Cases', () => {
    it(
      'tests that all open tabs are successfully listed',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
  ...
  describe('browser_open_tab - Success Cases', () => {
    it(
      'tests that a new tab with URL is successfully opened',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
    ...
    it(
      'tests that a new tab without URL is successfully opened',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_open_tab',
    ...
    it(
      'tests that a new tab in background is successfully opened',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_open_tab',
  ...
  describe('browser_close_tab - Success and Error Cases', () => {
    it(
      'tests that a tab is successfully closed by ID',
      async () => {
        await withMcpServer(async client => {
    ...
    it(
      'tests that invalid tab ID is handled gracefully',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_close_tab',
    ...
    it(
      'tests that non-numeric tab ID is rejected with validation error',
      async () => {
        await withMcpServer(async client => {
          try {
  ...
  describe('browser_switch_tab - Success and Error Cases', () => {
    it(
      'tests that switching to a tab by ID succeeds',
      async () => {
        await withMcpServer(async client => {
    ...
    it(
      'tests that switching to invalid tab ID is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_switch_tab',
  ...
  describe('browser_get_load_status - Success and Error Cases', () => {
    it(
      'tests that load status of active tab is successfully checked',
      async () => {
        await withMcpServer(async client => {
    ...
    it(
      'tests that checking load status of invalid tab ID is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_get_load_status',
  ...
  describe('Tab Management - Response Structure Validation', () => {
    it(
      'tests that all tab tools return valid MCP response structure',
      async () => {
        await withMcpServer(async client => {
          const tools = [
  ...
  describe('Tab Management - Workflow Tests', () => {
    it(
      'tests complete tab lifecycle: open -> switch -> close',
      async () => {
        await withMcpServer(async client => {
          // Open a new tab
          const openResult = await client.callTool({

...
describe('MCP Controller Coordinates Tools', () => {
  describe('browser_click_coordinates - Success Cases', () => {
    it(
      'tests that clicking at coordinates in active tab succeeds',
      async () => {
    ...
    it(
      'tests that clicking at top-left coordinates succeeds',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
    ...
    it(
      'tests that clicking at center coordinates succeeds',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
    ...
    it(
      'tests that clicking at zero coordinates succeeds',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
    ...
    it(
      'tests that clicking at large coordinates succeeds',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
    ...
    it(
      'tests that clicking with decimal coordinates is rejected',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
  ...
  describe('browser_click_coordinates - Error Handling', () => {
    ...
    it(
      'tests that missing coordinates is rejected',
      async () => {
        await withMcpServer(async client => {
          try {
            await client.callTool({
    ...
    it(
      'tests that non-numeric coordinates is rejected',
      async () => {
        await withMcpServer(async client => {
          try {
            await client.callTool({
    ...
    it(
      'tests that negative coordinates are handled',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
  ...
  describe('browser_type_at_coordinates - Success Cases', () => {
    it(
      'tests that typing at coordinates succeeds',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
    ...
    it(
      'tests that typing special characters at coordinates succeeds',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
    ...
    it(
      'tests that typing empty string at coordinates is rejected',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
    ...
    it(
      'tests that typing unicode at coordinates succeeds',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
    ...
    it(
      'tests that typing long text at coordinates succeeds',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
    ...
    it(
      'tests that typing multiline text at coordinates succeeds',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
  ...
  describe('browser_type_at_coordinates - Error Handling', () => {
    it(
      'tests that missing text is rejected',
      async () => {
        await withMcpServer(async client => {
          try {
            await client.callTool({
  ...
  describe('Coordinates Tools - Response Structure Validation', () => {
    it(
      'tests that coordinates tools return valid MCP response structure',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',
  ...
  describe('Coordinates Tools - Workflow Tests', () => {
    it(
      'tests coordinate workflow: navigate → click → type',
      async () => {
        await withMcpServer(async client => {
          // Navigate to URL
          await client.callTool({
    ...
    it(
      'tests multiple coordinate clicks in sequence',
      async () => {
        await withMcpServer(async client => {
          const tabResult = await client.callTool({
            name: 'browser_get_active_tab',

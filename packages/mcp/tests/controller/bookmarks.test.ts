...
describe('MCP Controller Bookmark Tools', () => {
  describe('browser_get_bookmarks - Success Cases', () => {
    it(
      'tests that getting all bookmarks succeeds',
      async () => {
    ...
    it(
      'tests that getting bookmarks from specific folder succeeds',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_get_bookmarks',
    ...
    it(
      'tests that empty bookmarks list is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_get_bookmarks',
  ...
  describe('browser_create_bookmark - Success Cases', () => {
    it(
      'tests that creating bookmark with title and URL succeeds',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
    ...
    it(
      'tests that creating bookmark with parentId succeeds',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_create_bookmark',
    ...
    it(
      'tests that creating bookmark with special characters succeeds',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_create_bookmark',
    ...
    it(
      'tests that creating bookmark with unicode title succeeds',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_create_bookmark',
    ...
    it(
      'tests that creating bookmark with localhost URL succeeds',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_create_bookmark',
  ...
  describe('browser_create_bookmark - Error Handling', () => {
    it(
      'tests that missing title is rejected',
      async () => {
        await withMcpServer(async client => {
          try {
    ...
    it(
      'tests that missing URL is rejected',
      async () => {
        await withMcpServer(async client => {
          try {
            await client.callTool({
    ...
    it(
      'tests that empty title is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_create_bookmark',
  ...
  describe('browser_remove_bookmark - Success Cases', () => {
    it(
      'tests that removing bookmark by ID succeeds',
      async () => {
        await withMcpServer(async client => {
    ...
    it(
      'tests that removing multiple bookmarks sequentially succeeds',
      async () => {
        await withMcpServer(async client => {
  ...
  describe('browser_remove_bookmark - Error Handling', () => {
    it(
      'tests that missing bookmarkId is rejected',
      async () => {
        await withMcpServer(async client => {
          try {
            await client.callTool({
    ...
    it(
      'tests that invalid bookmarkId is handled',
      async () => {
        await withMcpServer(async client => {
          const result = await client.callTool({
            name: 'browser_remove_bookmark',
  ...
  describe('Bookmark Tools - Response Structure Validation', () => {
    it(
      'tests that bookmark tools return valid MCP response structure',
      async () => {
        await withMcpServer(async client => {
          const tools = [
  ...
  describe('Bookmark Tools - Workflow Tests', () => {
    it(
      'tests complete bookmark workflow: create → get → verify → remove',
      async () => {
        await withMcpServer(async client => {
          // Create bookmark
          const createResult = await client.callTool({
    ...
    it(
      'tests bookmark batch operations workflow',
      async () => {
        await withMcpServer(async client => {
          const bookmarks = [
          ...
          for (const bookmark of bookmarks) {
            ...
            assert.ok(!result.isError, `Creating ${bookmark.title} should succeed`);
